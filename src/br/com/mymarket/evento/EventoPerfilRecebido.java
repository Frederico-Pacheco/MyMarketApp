...
public class EventoPerfilRecebido extends BroadcastReceiver implements EventoDelegate{
    ...
    public EventoPerfilRecebido registraObservador(BuscaInformacaoDelegate delegate){
